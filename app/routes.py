...
Generic CRUD over the `auth` table. Every mutating endpoint publishes a
domain event (auth.session.started) and an audit event; reads publish audit only.
...
TABLE = "auth"
RESOURCE = "auth"
CREATED_EVENT = "auth.session.started"
UPDATED_EVENT = ""
